...
from testmon.testmon_core import Testmon, eval_environment, TestmonData, home_file, TestmonConfig
...
def testmon_options(config):
    result = []
    for label in ['testmon', 'no-testmon',
                  'environment_expression', 'project_directory',
                  ]:
...
def pytest_configure(config):
    ...
    message, should_collect, should_select = testmon_config.header_collect_select(config, coverage_stack)
